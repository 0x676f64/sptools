...
class _CategoryItemsPageState extends State<CategoryItemsPage> {
  ...
  void _filterItems() {
    ...
    setState(() {
      filteredCategoryItems = query.isEmpty
          ? categoryItems
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ProductDetailPage(
          ...
          isItemInWishlist: (id) => widget.isItemInWishlist(id) as bool,
  ...
  Future<void> _fetchCategoryItems() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (decodedData != null &&
            decodedData['items'] != null &&
            decodedData['items'] is List) {
          setState(() {
          ...
          setState(() {
            _categoryItemsError =
                'No items found in ${widget.categoryName} or invalid data structure.';
            _isLoadingCategoryItems = false;
          });
        }
      } else {
        setState(() {
          _categoryItemsError =
              'Failed to load items for ${widget.categoryName}: ${response.statusCode}';
          _isLoadingCategoryItems = false;
        });
      }
    } catch (e) {
      setState(() {
        _categoryItemsError =
            'An error occurred loading items for ${widget.categoryName}: $e';
        _isLoadingCategoryItems = false;
      });
    }
  }
  ...
  Widget _buildCategoryItemsGrid() {
    if (_isLoadingCategoryItems) {
      ...
      return Center(
          child: Text(_categoryItemsError,
              style: const TextStyle(
                  color: Colors.red, fontFamily: 'Roboto Condensed')));
      ...
      return GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          if (item != null &&
              ...
              item['pricelevel1_formatted'] != null) {
            return Container(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: SizedBox(
                      height: 120,
                      child: Center(
                        child: (item['itemimages_detail']?['urls'] != null &&
                        ...
                        ? ElevatedButton(
                            onPressed: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Added ${item['displayname']} to cart',
                                    style: const TextStyle(
                                        fontFamily: 'Roboto Condensed'),
                                  ),
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: const TextStyle(
                          color: Colors.grey, fontFamily: 'Roboto Condensed'),
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      child: const Text('Promotions',
                          style:
                              TextStyle(fontFamily: 'Roboto Condensed')),
                    ),
